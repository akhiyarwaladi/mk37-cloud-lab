...
| Berkas | Keterangan |
|---|---|
| `arsip_ke_s3.py` | Fungsi arsip_ke_s3(): tambahan untuk kirim_email.py Pertemuan 3 (Langkah 4). |
| `operasi_cli_s3.sh` | Operasi CLI inti S3: cp, ls, sync, rm, presign (Langkah 3). |
